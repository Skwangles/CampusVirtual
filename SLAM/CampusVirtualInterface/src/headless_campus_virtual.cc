...
double mono_tracking(const std::shared_ptr<stella_vslam::system>& slam,
    ...
    return timestamp; // return the timestamp of the last frame
}
...
int main(int argc, char* argv[]) {
    ...
    // Viewers removed for headless Campus Virtual
