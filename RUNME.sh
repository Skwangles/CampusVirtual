...
./runCampusVirtual false ./ S-Block-From-G.mp4 --in g.db --out otherbuildings.db --media_dir /media/skwangles/KINGSTON/MEDIA/TestVideo/ --map_dir /home/skwangles/Documents/Honours/MEDIA/Maps/ --json_dir /media/skwangles/KINGSTON/MEDIA/JSON/ --picture-dir /media/skwangles/KINGSTON/MEDIA/pictures
...
# Send to Postgres
# ./runCampusVirtual true ./ --videos . --in otherbuildings.db --out . --media_dir . --map_dir /home/skwangles/Documents/Honours/MEDIA/Maps/ --json_dir /media/skwangles/KINGSTON/MEDIA/JSON/ --convertToPg
